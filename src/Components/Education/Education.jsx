...
const Education = ({ eduRef }) => {
  ...
  return (
    <section ref={eduRef} className="max-w-7xl m-auto px-4 py-16">
      ...
      <section className="space-y-5">
        {education?.map((edu, index) => {
          const institutionLink = getExternalLink(edu?.institutionLink);
              ...
              <h3 className="text-2xl font-bold leading-tight">
                ...
                {institutionLink ? (
                  <a
                    ...
                    onClick={(event) =>
                      handleExternalLink(event, edu?.institutionLink)
                    }
                  ...
                  <span className="text-teal-200">{edu?.institution}</span>
                )}
              </h3>
